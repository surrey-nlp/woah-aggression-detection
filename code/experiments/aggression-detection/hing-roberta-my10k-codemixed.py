...
class CustomTrainer(Trainer):
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        loss_fct = nn.CrossEntropyLoss(weight=torch.tensor([0.21, 0.33, 0.46]).to(device))  # Compute custom loss
...
class Seq_Classifier:
    ...
    def read_data(self):
        train_set = pd.read_csv('/jmain02/home/J2AD011/hxc16/dxk50-hxc16/workspace/nn007/Datasets/Finalized/Aggression/codemixed/CMagg-train.csv', encoding='latin-1')  # Paths to the datasets
        valid_set = pd.read_csv('/jmain02/home/J2AD011/hxc16/dxk50-hxc16/workspace/nn007/Datasets/Finalized/Aggression/codemixed/CMagg-val.csv', encoding='latin-1')
        test_set = pd.read_csv('/jmain02/home/J2AD011/hxc16/dxk50-hxc16/workspace/nn007/Datasets/Finalized/Aggression/codemixed/CMagg-test.csv', encoding='latin-1')
    ...
    def process_DS(self):
        ...
        test_labels = list(test_df['aggression'])
    ...
    def gen_results_on_test(self, trainer, test_dataset, log_dir, s):
        ...
        map_dt = {0:'NAG', 1:'CAG', 2:'OAG'}    # Map labels to aggression classes
