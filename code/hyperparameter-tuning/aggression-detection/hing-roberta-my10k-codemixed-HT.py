...
class Seq_Classifier_HT:
    ...
    def read_data(self):
        train_set = pd.read_csv('/jmain02/home/J2AD011/hxc16/dxk50-hxc16/workspace/nn007/Datasets/Finalized/Aggression/codemixed/CMagg-train.csv')  # Paths to the datasets
        valid_set = pd.read_csv('/jmain02/home/J2AD011/hxc16/dxk50-hxc16/workspace/nn007/Datasets/Finalized/Aggression/codemixed/CMagg-val.csv')
